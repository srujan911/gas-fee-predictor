...
# Create a heatmap with realistic Etherscan data including values below 1 GWEI
def create_etherscan_realistic_heatmap(output_path):
    # Days of the week
...
if __name__ == "__main__":
    ...
    results = create_etherscan_realistic_heatmap(output_path)
